...
export function DensityToggle({ className }: { className?: string }) {
  ...
  return (
    <button
      ...
      className={cn(
        'hidden items-center rounded-md border border-border px-2 py-1 text-2xs font-medium text-muted-foreground transition-colors hover:text-foreground sm:inline-flex',
        className
      )}
    >
