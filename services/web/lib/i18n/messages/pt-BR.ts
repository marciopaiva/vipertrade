...
const ptBR: Messages = {
  ...
  swing: {
    ...
    colSymbol: 'Símbolo',
    colState: 'Estado',
    colTrend: '1 · Tendência (EMA200)',
    colPullback: '2 · Recuo (EMA50)',
    colRisk: '3 · Risco',
    colDistance: 'Falta para o gatilho',
    colStop: 'Stop se entrasse',
    colTarget: 'Alvo se entrasse',
    colChart: '4H (velas)',
    atTrigger: 'no gatilho',
    st_setup: 'SETUP',
