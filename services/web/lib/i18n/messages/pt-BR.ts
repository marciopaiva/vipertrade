...
const ptBR: Messages = {
  ...
  live: {
    ...
    followTitle: 'Follow-through de entrada · avançou vs morreu natimorta',
    followArmed: 'Avançou (chegou a cobrir o custo)',
    followNotArmed: 'Natimorta (nunca esteve no lucro líquido)',
  ...
  strategy: {
    ...
    rMacd: 'MACD sem cruzamento a favor',
    rVolume: 'volume 24h abaixo do mínimo',
    rRegime: 'regime de consenso neutro',
    rDirectional: 'checagens direcionais não passaram',
    rRsi: 'RSI fora da faixa de entrada',
    rRiskGate: 'limite de risco da conta atingido',
    rMaxOpen: 'limite de posições simultâneas atingido',
    rRuntimeOff: 'scalp desligado — sem avaliação de entrada',
    sideBullish: 'altista',
