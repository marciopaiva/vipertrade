...
pub(crate) fn execute_validate_entry(state: &Value, cfg: &StrategyConfig) -> Result<Value, String> {
    ...
    push_weighted_entry_component(&mut components, "bybit_regime", bybit_regime_score, 20.0);
    ...
    push_weighted_entry_component(&mut components, "exchange_consensus", consensus_score, 20.0);
    ...
    push_weighted_entry_component(&mut components, "ema_alignment", ema_alignment_score, 10.0);
    ...
    push_weighted_entry_component(&mut components, "macd_cross", macd_score, 15.0);
